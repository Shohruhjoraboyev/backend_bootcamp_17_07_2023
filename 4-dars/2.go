...
func main() {
	...
	createUser(User{Name: "Diyorbek", FavouriteProducts: []int{1, 5, 2, 9, 11, 3}})
	fmt.Println(readUserByID(6))

	fmt.Println("\nreadAllUser by name=bek")
	fmt.Println(readAllUser("bek"))
...
func readAllUser(name string) string {
	res := ""
	for _, user := range users {
