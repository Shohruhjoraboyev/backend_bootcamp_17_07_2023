...
// func (*transactionRepo) GetTopStaffs(ctx context.Context, models.TopWorkerRequest) (map[string]models.StaffTop, error) {
// 	panic("unimplemented")
// }
...
func (t *transactionRepo) GetTransaction(ctx context.Context, req *models.IdRequest) (resp *models.Transaction, err error) {
...
func (t *transactionRepo) GetAllTransaction(ctx context.Context, req *models.GetAllTransactionRequest) (*models.GetAllTransactionResponse, error) {
	...
	rows, err := t.db.Query(ctx, query, req.Text, req.Limit, (req.Page-1)*req.Limit)
	if err != nil {
	...
	countQuery := `
		...
		WHERE text ILIKE '%' || $1 || '%'
	`
	err = t.db.QueryRow(ctx, countQuery, req.Text).Scan(&response.Count)
	if err != nil {
...
func (t *transactionRepo) UpdateTransaction(ctx context.Context, req *models.Transaction) (string, error) {
	...
	result, err := t.db.Exec(ctx, query, req.Amount, req.Source_type, req.Text, req.Sale_id, req.Staff_id, req.Id)
	if err != nil {
...
func (t *transactionRepo) DeleteTransaction(ctx context.Context, req *models.IdRequest) (string, error) {
	...
	result, err := t.db.Exec(ctx, query, req.Id)
	if err != nil {
