...
func (b *branchRepo) GetBranch(ctx context.Context, req *models.IdRequest) (resp *models.Branch, err error) {
...
func (b *branchRepo) UpdateBranch(ctx context.Context, req *models.Branch) (string, error) {
	...
	result, err := b.db.Exec(ctx, query, req.Name, req.Address, year, req.FoundedAt, req.ID)
	if err != nil {
...
func (b *branchRepo) GetAllBranch(ctx context.Context, req *models.GetAllBranchRequest) (*models.GetAllBranch, error) {
...
func (b *branchRepo) DeleteBranch(ctx context.Context, req *models.IdRequest) (resp string, err error) {
