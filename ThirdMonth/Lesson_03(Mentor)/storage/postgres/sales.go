...
func (s *salesRepo) CreateSale(ctx context.Context, req *models.CreateSale) (string, error) {
	id := uuid.NewString()
...
func (s *salesRepo) GetSale(ctx context.Context, req *models.IdRequest) (resp *models.Sales, err error) {
...
func (c *salesRepo) GetAllSale(ctx context.Context, req *models.GetAllSaleRequest) (*models.GetAllSaleResponse, error) {
...
func (s *salesRepo) UpdateSale(ctx context.Context, req *models.Sales) (string, error) {
	...
	result, err := s.db.Exec(ctx, query, req.ClientName, req.Branch_id, req.Shop_asisstent_id, req.Cashier_id, req.Price, req.Payment_Type, req.Status, req.Id)
	if err != nil {
...
func (s *salesRepo) DeleteSale(ctx context.Context, req *models.IdRequest) (string, error) {
