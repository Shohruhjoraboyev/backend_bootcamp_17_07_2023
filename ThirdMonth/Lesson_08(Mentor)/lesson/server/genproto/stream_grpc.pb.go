...
func (c *streamServiceClient) Count(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_CountClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/branches.StreamService/Count", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) Sum(ctx context.Context, opts ...grpc.CallOption) (StreamService_SumClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[1], "/branches.StreamService/Sum", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) Sqr(ctx context.Context, opts ...grpc.CallOption) (StreamService_SqrClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[2], "/branches.StreamService/Sqr", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) Fibonacci(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_FibonacciClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[3], "/branches.StreamService/Fibonacci", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *streamServiceClient) Translate(ctx context.Context, opts ...grpc.CallOption) (StreamService_TranslateClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[4], "/branches.StreamService/Translate", opts...)
	if err != nil {
		return nil, err
	}
...
var StreamService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "branches.StreamService",
